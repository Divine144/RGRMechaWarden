...
public class ShockTrapBlockItem extends BlockItem implements GeoItem {
    private final AnimatableInstanceCache instanceCache = GeckoLibUtil.createInstanceCache(this);

    public ShockTrapBlockItem(Block pBlock, Properties pProperties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new GeoItemRenderer<ShockTrapBlockItem>(new DefaultedItemGeoModel<>(new ResourceLocation(RGRMechaWarden.MODID, "shock_trap_be"))) {
                        @Override
