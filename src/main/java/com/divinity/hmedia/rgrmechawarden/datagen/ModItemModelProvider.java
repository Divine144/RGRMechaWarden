...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        Stream.of(ItemInit.MOUNTED_WRIST_ROCKETS, ItemInit.MECHA_WARDEN_LASER, ItemInit.BLOCK_MORPH, ItemInit.SCULKY_SNACK, ItemInit.MECHO_LOCATION, ItemInit.DEEP_DARK_DESTROYER)
                .map(Supplier::get)
