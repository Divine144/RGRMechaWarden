...
public class DirectMissileEntityRenderer extends GeoEntityRenderer<DirectMissileEntity> {

    public DirectMissileEntityRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SimpleGeoEntityModel<>(RGRMechaWarden.MODID, "missile"));
    }
    @Override
    public void render(DirectMissileEntity entity, float entityYaw, float partialTick, PoseStack pMatrixStack, MultiBufferSource bufferSource, int packedLight) {
